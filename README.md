...
`KC 기준 검토 > 설치 전 설계자료`에서 설계도면·제조사 사양서·건물 계획자료 등 계산 입력의 출처를 프로젝트에 함께 저장할 수 있습니다. NCS `승강기 설치계획 수립` 능력단위를 참고한 자체 작성 양식이며, 설치 후 현장 점검이나 KC 적합 판정 기능은 아닙니다. 근거와 범위는 [NCS 참고 문서](docs/NCS_REFERENCE.md)를 보세요.
